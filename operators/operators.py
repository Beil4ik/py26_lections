...
# условные операторы - они созданы, чтоьбы программа могла выполнять рвзные участки кода в зависимости от условия
#  if, elif, else
...
#     <body elif>
# else:
#     <body else> #срботает только если во всех остальных false
...
# else: print('Ty prohodish\' po vozrastu, Welcome!')
