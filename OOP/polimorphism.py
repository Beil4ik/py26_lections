...
# Абстракция(Абстрактный класс) - его можно рассматривать как набор методов, которые должны быть реализованы во всех дочерних классах, котоыре будут унаследованы от абстрактного класса
...
#     def info(self):
#         print(f'Я {self.name}, и я фигура в двухмерной плосткости!')
...
#             raise Exception('Телефон разряжён!')
...
#                 if self.__battery_level > 100:
#                     self.__battery_level = 100
#             print(f'Идёт зарядка батареи! Ваш уровень заряда: {self.__battery_level}')
#             i += 1

# phone = Smartphone('IOS 15', '17710123-123')
# phone.get_info
# phone.play_music()
# phone.watching_video()
# phone.battery_level
