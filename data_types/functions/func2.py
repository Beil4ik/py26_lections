...
# print(sum_of_args(a=5, b=10, c=15, d=20)) # keyword arguments (Именованные аргументы)
...
# def printScores(student, *scores): #*args
...
#     print(pets)
#     pets.pop('cat')
#     print(dict(**pets)) # dog'Rex', 'fish[..]', turtle=..
#     print(type(pets))

# print_pet_names('John Snow', dog='Rex', cat='Gargild', fish=['Nemo', 'Dori', 'Alex'], turtle='Donatello')
'-------------------------------------------------------------------------'
...
# def get_some_data(a, b, *args, **kwards):
#     print('Параметры a и b:', a, b)
#     print('Аргументы:', args)
#     print('Именованные аргументы:', kwards)
#     # print(args[0])
#     # print(args[-1])
#     # print(kwards['name'])

# get_some_data(1, 2, 3, 4, 5, lang='Python', name='John Snow', car='BMV M8')
